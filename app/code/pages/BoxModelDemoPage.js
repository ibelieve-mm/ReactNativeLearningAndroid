    ...
    render() {
        return (
            <View style={[BoxStyles.box, BoxStyles[this.props.width], BoxStyles[this.props.height]]}>
                <View
                    style={[BoxStyles.top, BoxStyles.height50, BoxStyles[this.props.classBg]]}><Text>top</Text></View>
...
export default class BoxModelDemoPage extends Component {
    render() {
        return (
            <View style={BoxStyles.page}>
                <TitleView
                    instance={this}
                    title="Box模型演示"/>
                <MargginBox>
